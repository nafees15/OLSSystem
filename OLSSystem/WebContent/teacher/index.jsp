...
<div id="wrapper">
		<div id="header">
			...
			<div id="user_nav">
					<div id='nav'>
					<ul>
					   <li><span>[Reinhold,Karin]>></span></li>
		...
		<div id="content">
			<div id="left">
				<div id="edit">
			 		<button onclick="loadXMLDoc('addCourseTable.jsp')">+Add Course</button>
			 		<button onclick="loadXMLDoc('requestOpenCourseTable.jsp')">Request Open Course</button>
			 		<div id="edit_div"> </div>
			    </div>
			    <div id="course_list">
				<table id="c_table">
